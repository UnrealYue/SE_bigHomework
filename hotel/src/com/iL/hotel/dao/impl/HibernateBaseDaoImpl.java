...
import com.iL.hotel.common.log.Logs;
import com.iL.hotel.common.utils.*;
...
public class HibernateBaseDaoImpl<T, PK extends Serializable>  implements HibernateBaseDao<T, PK> {
    ...
    */
	...
	/* (non-Javadoc)
	 * @see org.werun.template.dao.HibernateBaseDao#findPageList(java.lang.String, java.util.Map, org.werun.template.common.utils.Page, org.werun.template.common.utils.Sorter)
	 */
	@Override
	public void findPageList(String hqlQuery, Map<String, ?> map, Page page, Sorter sorter) {
		// TODO Auto-generated method stub
		Assert.hasText(hqlQuery, "hqlQuery不能为空");
        Assert.notNull(map, "map不能为空");
        Query query = AssembleHQL.createQuery(getSession(), hqlQuery, map, sorter).setCacheable(true).
                setFirstResult(page.getFirst() - 1).setMaxResults(page.getPageSize());
        if (page.isAutoCount()) {
            long totalCount = getTotalCount(hqlQuery,map);
            page.setTotalCount(totalCount);
	...
	/* (non-Javadoc)
	 * @see org.werun.template.dao.HibernateBaseDao#findPageList(java.lang.String, java.util.Map, org.werun.template.common.utils.Page, org.werun.template.common.utils.Sorter, org.werun.template.common.utils.Grouper)
	 */
	@Override
	public void findPageList(String hqlQuery, Map<String, ?> map, Page page, Sorter sorter, Grouper grouper) {
		// TODO Auto-generated method stub
		Assert.hasText(hqlQuery, "hqlQuery不能为空");
        Assert.notNull(map, "map不能为空");
        Query query = AssembleHQL.createQuery(getSession(), hqlQuery, map, sorter ,grouper).setCacheable(true).
                setFirstResult(page.getFirst() - 1).setMaxResults(page.getPageSize());
        if (page.isAutoCount()) {
            long totalCount = getTotalCount(hqlQuery,map);
            page.setTotalCount(totalCount);
    ...
    */
	...
	/* (non-Javadoc)
	 * @see org.werun.template.dao.HibernateBaseDao#findPageList(java.lang.String, java.util.Map, org.werun.template.common.utils.Page, org.werun.template.common.utils.Grouper)
	 */
